...
export async function GET() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.emergencyresponselibertycountywiki.wiki'
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'Emergency Response Liberty County Wiki'
